<template>
    <article class="product">
        <!-- Это можно было подключить с помощью SVGLoader, но в данной ситуации выгоднее вставить вручную  -->
        <svg class="product__favorite" width="20" height="20" viewBox="0 0 20 20" fill="none"
            xmlns="http://www.w3.org/2000/svg">
            <mask id="mask0_3937_865" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="20"
                height="20">
                <rect width="20" height="20" fill="#D9D9D9" />
            </mask>
            <g mask="url(#mask0_3937_865)">
                <path
